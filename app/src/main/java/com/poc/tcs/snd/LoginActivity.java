...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infiniteCycleViewPager.setAdapter(mCustomPagerAdapter);
        infiniteCycleViewPager.setScrollDuration(500);
      //  infiniteCycleViewPager.setInterpolator(R.anim);
    ...
    {
        Intent intent_loginClick = new Intent(this,AppOverView.class);
        startActivity(intent_loginClick);
    }
    /**
     *
